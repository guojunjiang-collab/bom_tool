...
from .routers import auth_router, users_router, parts_router, assemblies_router, bom_router, logs_router, dict_router, attachments_router, custom_fields_router, documents_router, dashboard_router
